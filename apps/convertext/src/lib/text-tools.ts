...
export class TextTools {
  ...
  static removeCsvColumns(text: string, columnsToRemove: string): string {
    ...
    for (let i = 1; i < lines.length; i++) {
      const values = lines[i].split(',').map((v) => v.trim());
      const newValues = indicesToKeep.map((index) => (index < values.length ? values[index] : ''));
    ...
    for (let p = 0; p < paragraphCount; p++) {
      ...
      for (let s = 0; s < sentenceCount; s++) {
        ...
        for (let w = 0; w < wordCount; w++) {
          ...
          words.push(
            w === 0 ? randomWord.charAt(0).toUpperCase() + randomWord.slice(1) : randomWord
          );
        }
  ...
  static getAvailableTools(): ToolSignature[] {
    return [
      ...
      },
      {
        ...
        description: 'Search and replace a single phrase (up to 100 chars)',
        renderMode: 'diff',
      ...
      },
      {
        ...
        description: 'Convert European number format to American format',
        renderMode: 'diff',
        params: ['text'],
      },
      {
        name: 'splitBySentences',
        description: 'Split text into separate lines by sentences',
        renderMode: 'diff',
        params: ['text'],
      },
      {
      ...
      {
        name: 'reverseText',
        description: 'Reverse entire text',
        renderMode: 'diff',
        params: ['text'],
      },
      {
        name: 'repeatText',
        description: 'Repeat text multiple times (1-100)',
        renderMode: 'output',
        params: ['text', 'times'],
      },
      ...
      {
        name: 'removeCsvColumns',
        description: 'Remove specified columns from CSV data',
        renderMode: 'diff',
        params: ['text', 'columnsToRemove'],
      },
      ...
      {
        name: 'shuffleParagraphs',
        description: 'Randomly shuffle paragraphs',
        renderMode: 'diff',
        params: ['text'],
      },
      {
        name: 'invertCase',
        description: 'Invert uppercase/lowercase',
        renderMode: 'diff',
        params: ['text'],
      },
      {
      ...
      {
        name: 'joinWords',
        description: 'Join words with custom separator',
        renderMode: 'diff',
      ...
      },
      {
        ...
        description: 'Split text into numbered paragraphs',
        renderMode: 'diff',
        params: ['text'],
      },
      {
      ...
      {
        name: 'getTextStatistics',
        description: 'Get comprehensive text statistics',
        renderMode: 'output',
        params: ['text'],
      },
      ...
      {
        name: 'removeXmlTags',
        description: 'Remove XML tags from text',
        renderMode: 'diff',
        params: ['text'],
      },
      {
        name: 'centerText',
        description: 'Center text within specified width (1-200)',
        renderMode: 'diff',
        params: ['text', 'width'],
      },
      {
        name: 'indentText',
        description: 'Indent text with spaces (0-20)',
        renderMode: 'diff',
        params: ['text', 'spaces'],
      },
      {
      ...
      // Text Generators
      {
        ...
        description: 'Generate Lorem Ipsum text (1-10 paragraphs)',
        renderMode: 'output',
        params: ['paragraphs'],
      },
      {
        name: 'generateRandomWords',
        description: 'Generate random words (1-1000)',
        renderMode: 'output',
        params: ['count'],
      },
      {
        name: 'generateRandomLetters',
        description: 'Generate random letters (1-10000)',
        renderMode: 'output',
        params: ['count'],
      },
    ];
